...
import { IAnnotationClass, defaultAnnotationClasses } from './quick-anno.utils';
...
@Component({
  ...
  templateUrl: './quick-anno.component.html',
  styleUrls: ['./quick-anno.component.scss']
})
/**
 * Komponente für die Darstellung des QuickAnnotator Werkzeuges
 */
export class QuickAnnoComponent implements OnInit, OnDestroy {
